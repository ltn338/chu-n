...
const fs = require("fs");
   const { threadID, messageID, senderID } = event;
    ...
    if (!args[0]) {
     var msg = {body: `[ 𝗥𝗘𝗣𝗟𝗬 ] 𝗧𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝘃𝗮̀ 𝗰𝗵𝗼̣𝗻 𝗧𝗵𝘂̛̉ 𝗧𝗵𝗮́𝗰𝗵 𝗵𝗮𝘆 𝗦𝘂̛̣ 𝗧𝗵𝗮̣̂𝘁 🎁 \n🍑====================🍑\nㅤㅤㅤ𝟏. 𝗧𝗵𝘂̛̉ 𝗧𝗵𝗮́𝗰𝗵 🐥\nㅤㅤㅤ𝟐. 𝗦𝘂̛̣ 𝗧𝗵𝗮̣̂𝘁 🐰\n🍭====================🍭\n𝗖𝗼́ 𝗰𝗵𝗼̛𝗶 𝗰𝗼́ 𝗰𝗵𝗶̣𝘂 𝗕𝘂̀𝗺 𝗸𝗲̀𝗼 𝗰𝗼𝗻 𝗰𝗮̣̆𝗰`}
  ...
  const axios = require("axios");
    ...
    if (event.senderID != author) return api.sendMessage("====[ 𝐖𝐀𝐑𝐍𝐈𝐍𝐆 ]====\n𝐄́𝐨 𝐩𝐡𝐚̉𝐢 𝐭𝐡𝐚̆̀𝐧𝐠 𝐝𝐮̀𝐧𝐠 𝐥𝐞̣̂𝐧𝐡 𝐭𝐡𝐢̀ 𝐜𝐮́𝐭 𝐜𝐡𝐨 𝐭𝐡𝐚̆̀𝐧𝐠 𝐝𝐮̀𝐧𝐠 𝐥𝐞̣̂𝐧𝐡 𝐜𝐡𝐨̛𝐢", event.threadID, event.messageID); 
    ...
    return api.sendMessage(`𝗧𝗵𝘂̛̉ 𝗧𝗵𝗮́𝗰𝗵 🐥: ${dare[Math.floor(Math.random()*dare.length)]}`, event.threadID, event.messageID)
        ...
        case "2": {
          api.unsendMessage(handleReply.messageID);
    return api.sendMessage(`𝗦𝘂̛̣ 𝗧𝗵𝗮̣̂𝘁 🐰: ${truth[Math.floor(Math.random()*truth.length)]}`, event.threadID, event.messageID)
            }
            break;
					default:
