...
module.exports.config = {
	...
	usages: "/datlich Nội dung | ngày/tháng/năm_giờ:phút:giây", // Cách sử dụng lệnh
...
//DEFINE PATH
const path = __dirname + '/hethong/datlich.json';
...
module.exports.run = async function ({ api, event, args, Users }) {
	...
	// CHECK CHECK CHECK
	if (date[0].split("/").length != 3 || date[1].split(":").length != 3) return api.sendMessage("Bạn phải nhập đúng định dạng Nội dung | ngày/tháng/năm_giờ:phút:giây", threadID, messageID);
