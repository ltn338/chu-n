module.exports.config = {
  ...
  switch (l = 1, s.type) {
    case "choose":
      switch (n.body) {
        case "1":
          return e.sendMessage("[⚜️]→ Prefix của bot là : " + global.config.PREFIX, n.threadID, n.messageID);
        case "2":
          return e.sendMessage("[⚜️]→ Tên của bot là : " + global.config.BOTNAME, n.threadID, n.messageID);
        case "3": {
          ...
          for (const e of a)
            if (parseInt(e)) {
              ...
              m.push(`${n} - ${e}`)
            } return e.sendMessage(`[⚜️]→ Danh sách toàn bộ người điều hành bot: \n\n${m.join("\n")}`, n.threadID, n.messageID)
        }
        case "4":
          if ("vi" == global.config.language) return e.sendMessage("[⚜️]→ Ngôn ngữ: Tiếng Việt", n.threadID, n.messageID);
          "en" == global.config.language && e.sendMessage("[⚜️]→ Language : English", n.threadID, n.messageID);
          break;
