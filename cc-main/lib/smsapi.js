...
/**
 * Đầy đủ API, đã bổ sung mocha, dkimu, sapo, hoang... 
 * Lưu ý: Nếu có tên hàm trùng nhau (shop), nên đổi tên! Ở đây sẽ sửa thành shop1, shop2 (theo Python gốc).
 */
...
// ==== EXPORT TOÀN BỘ (đúng thứ tự Python) ====
module.exports = [
